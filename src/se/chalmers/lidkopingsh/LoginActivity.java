...
public class LoginActivity extends Activity {
	...
	// TODO: Provide password recovery in the action overflow?
	@Override
	...
	public void attemptLogin() {
		...
		// TODO: Consider improving email check
	...
	private enum Response {
		SUCCESS, INVALID_LOGIN_CREDENTIALS, NO_NETWORK
	}
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Response> {
		...
		protected void onPostExecute(final Response response) {
			...
			case INVALID_LOGIN_CREDENTIALS:
				...
				break;
			case NO_NETWORK:
				// TODO: Implement a no network error message
				Log.d("DEBUG", "No network");
				break;
			default:
				throw new IllegalStateException("Not known server response");
			}
		}
