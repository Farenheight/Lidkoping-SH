 ...
 * {@link StoneDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link StoneListFragment} and the item details (if present) is a
 * {@link StoneDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link StoneListFragment.Callbacks} interface to listen for item selections.
 */
public class StoneListActivity extends FragmentActivity implements
