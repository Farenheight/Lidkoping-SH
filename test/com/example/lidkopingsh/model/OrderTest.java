...
public class OrderTest {
	...
	public void testListeners() {
		...
		Task task0 = new Task(new Station(0,"Station0"));
		Task task1 = new Task(new Station(1,"Station1"));

		Product product1 = new Stone(1, "", "", "", null, "", "", "", "");
		Task task2 = new Task(new Station(2,"Station2"));
		Task task3 = new Task(new Station(3,"Station3"));
		...
		Task task4 = new Task(new Station(0,"Station0"));
		Task task5 = new Task(new Station(1,"Station1"));

		Product product3 = new Stone(1, "", "", "", null, "", "", "", "");
		Task task6 = new Task(new Station(2,"Station2"));
		Task task7 = new Task(new Station(3,"Station3"));
